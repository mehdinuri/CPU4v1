...
void MX_I2C4_Init(void)
{
  ...
  hi2c4.Instance = I2C4;
  hi2c4.Init.Timing = 0x10F0277E;
  hi2c4.Init.OwnAddress1 = 783;
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    */
    ...
    /* I2C4 DMA Init */
    /* I2C4_RX Init */
    hdma_i2c4_rx.Instance = DMA1_Channel3;
    ...
    /* I2C4_TX Init */
    hdma_i2c4_tx.Instance = DMA1_Channel4;
...
/* USER CODE BEGIN 1 */
void I2CDeInit(I2C_HandleTypeDef* hi2c)
{
	HAL_I2C_DeInit(hi2c);
}
