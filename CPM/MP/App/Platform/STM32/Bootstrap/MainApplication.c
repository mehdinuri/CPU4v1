...
FieldBusRxAdapterCtx_t *MainApplicationGetFieldBusRxAdapter(void)
{
  return &s_fieldBusRxCtx;
}
...
void MainApplication_Init(void)
{
  ...
  FieldBusRxAdapterInit(&s_fieldBusRxCtx, &hfdcan1);
  ...
  g_fieldBusPort = FieldBusRxAdapterCreatePort(&s_fieldBusRxCtx);
