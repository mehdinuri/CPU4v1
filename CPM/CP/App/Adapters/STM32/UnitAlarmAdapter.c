/* App/Adapters/STM32/UnitAlarmAdapter.c */
#include "UnitAlarmAdapter.h"

#include <string.h>

static uint8_t AdapterGetMaxAlarmGroups(void *ctx, uint8_t *maxAlarmGroups)
{
  UnitAlarmAdapterCtx_t *adapter = (UnitAlarmAdapterCtx_t *) ctx;
                                         ...
                                         uint8_t alarmGroupState)
{
  ...
  if (groupIndex >= adapter->maxAlarmGroups)
  {
    return 0U;
  }
