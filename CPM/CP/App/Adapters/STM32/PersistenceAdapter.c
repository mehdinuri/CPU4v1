...
static const PersistenceLayout_t saLayout[] = {
  ...
  { PERSIST_OBJECT_SNMP_BOOTSTRAP_INFO, MSM_REQ_EEPROM_READ,
    MSM_REQ_EEPROM_WRITE, MSM_REQ_NONE,
    EEPROM_STORAGE_ADDR_SNMP_BOOTSTRAP_INFO,
    sizeof(tSMCSSNMPBootstrapInfo) },
  { PERSIST_OBJECT_SNMPV3_BOOTSTRAP_STATE, MSM_REQ_EEPROM_READ,
    MSM_REQ_EEPROM_WRITE, MSM_REQ_NONE,
