                                          ...
                                          errorInfo)
{
  ...
  switch (errorInfo.type)
  {
      ...
      case INTERSECTION_CONFIG_ERROR_IO_MAP_DESCRIPTION:
      {
        CopyErrorString(service, "ascIOmapDescription is invalid");
        break;
      }

      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_DEVICE_TYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_DEVICE_PNN:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_DEVICE_PTYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_DEVICE_ADDR:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_DEVICE_PIN:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_FUNCTION_TYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_FUNCTION_PTYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_FUNCTION:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_OUTPUT_FUNCTION_INDEX:
      {
        CopyErrorString(service, "ascIOoutputMap row is invalid");
        break;
      }

      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_DEVICE_TYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_DEVICE_PNN:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_DEVICE_PTYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_DEVICE_ADDR:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_DEVICE_PIN:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_FUNCTION_TYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_FUNCTION_PTYPE:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_FUNCTION:
      case INTERSECTION_CONFIG_ERROR_IO_MAP_INPUT_FUNCTION_INDEX:
      {
        CopyErrorString(service, "ascIOinputMap row is invalid");
        break;
      }
