...
#define INTERSECTION_CHANNEL_COUNT_MAX 32U
#define INTERSECTION_OVERLAP_COUNT_MAX 32U
...
#define INTERSECTION_PED_INPUT_COUNT_MAX 32U
#define INTERSECTION_VEHICLE_DETECTOR_COUNT_MAX 32U
...
#define INTERSECTION_IO_MAP_COUNT_MAX 1U
#define INTERSECTION_IO_MAP_DESCRIPTION_MAX 32U
#define INTERSECTION_IO_MAP_MAX_INPUTS 64U
#define INTERSECTION_IO_MAP_MAX_OUTPUTS (INTERSECTION_CHANNEL_COUNT_MAX * 3U)
...
#ifndef INTERSECTION_IO_MAP_FEIG_DEVICE_PNN
#define INTERSECTION_IO_MAP_FEIG_DEVICE_PNN 0U
#endif

#ifndef INTERSECTION_IO_MAP_FEIG_DEVICE_PTYPE
#define INTERSECTION_IO_MAP_FEIG_DEVICE_PTYPE 0U
#endif

#ifndef INTERSECTION_IO_MAP_PED_DEVICE_PNN
#define INTERSECTION_IO_MAP_PED_DEVICE_PNN 0U
#endif

#ifndef INTERSECTION_IO_MAP_PED_DEVICE_PTYPE
#define INTERSECTION_IO_MAP_PED_DEVICE_PTYPE 0U
#endif
...
typedef enum
{
  INTERSECTION_IO_MAP_DEVICE_UNUSED = 1,
  INTERSECTION_IO_MAP_DEVICE_CUSTOM = 2,
  INTERSECTION_IO_MAP_DEVICE_FIO = 3,
  INTERSECTION_IO_MAP_DEVICE_TS1 = 4,
  INTERSECTION_IO_MAP_DEVICE_BIU = 5,
  INTERSECTION_IO_MAP_DEVICE_SIU = 6,
  INTERSECTION_IO_MAP_DEVICE_AUX = 7
} IntersectionIoMapDeviceType_t;

typedef enum
{
  INTERSECTION_IO_MAP_INPUT_FUNCTION_UNUSED_INPUT = 1,
  INTERSECTION_IO_MAP_INPUT_FUNCTION_IO_USED_AS_OUTPUT = 2,
  INTERSECTION_IO_MAP_INPUT_FUNCTION_PEDESTRIAN_DETECTOR = 34,
  INTERSECTION_IO_MAP_INPUT_FUNCTION_VEHICLE_DETECTOR = 53
} IntersectionIoMapInputFunction_t;

typedef enum
{
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_UNUSED_OUTPUT = 1,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_IO_USED_AS_INPUT = 2,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_LOGIC_OUTPUT = 3,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_ADV_WARN_GREEN = 4,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_ADV_WARN_RED = 5,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_ALARM_OUTPUT = 6,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_AUTOMATIC_FLASH_STATUS = 7,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_CHANNEL_GREEN = 8,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_CHANNEL_RED = 9,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_CHANNEL_YELLOW = 10,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_CODED_STATUS_BIT_A = 11,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_CODED_STATUS_BIT_B = 12,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_CODED_STATUS_BIT_C = 13,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_DETECTOR_RESET_SLOTS = 14,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_DETECTOR_RESET = 15,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_FAULT_MONITOR = 16,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_FLASHING_LOGIC = 17,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_FREE_STATUS = 18,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_OFFSET_OUTPUT = 19,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_PHASE_CHECK = 20,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_PHASE_NEXT = 21,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_PHASE_ON = 22,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_PREEMPT_ACTIVE = 23,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_PREEMPT_ACTIVE_ADVANCED = 24,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_SPECIAL_FUNCTION_OUTPUT = 25,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_TBC_AUX_OUTPUT = 26,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_TIMING_PLAN_OUTPUT = 27,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_VOLTAGE_MONITOR = 28,
  INTERSECTION_IO_MAP_OUTPUT_FUNCTION_WATCHDOG = 29
} IntersectionIoMapOutputFunction_t;
...
#define INTERSECTION_UNIT_FAILURE_FLASH_PERIOD_500MS_DS 5U
#define INTERSECTION_UNIT_FAILURE_FLASH_PERIOD_1000MS_DS 10U
#define INTERSECTION_UNIT_FAILURE_FLASH_PERIOD_2000MS_DS 20U
#define INTERSECTION_UNIT_FAILURE_FLASH_PERIOD_4000MS_DS 40U
...
typedef struct
{
  ...
  uint8_t functionPtype;
  uint8_t function;
  uint8_t functionIndex;
} IntersectionIoInputMapRowConfig_t;
...
typedef struct
{
  ...
  uint8_t function;
  uint8_t functionIndex;
} IntersectionIoOutputMapRowConfig_t;

typedef struct
{
  uint8_t description[INTERSECTION_IO_MAP_DESCRIPTION_MAX];
  IntersectionIoInputMapRowConfig_t inputs[INTERSECTION_IO_MAP_MAX_INPUTS];
  IntersectionIoOutputMapRowConfig_t outputs[INTERSECTION_IO_MAP_MAX_OUTPUTS];
} IntersectionIoMapConfig_t;
...
typedef enum
{
  ...
  INTERSECTION_CONFIG_ERROR_IO_MAP_DESCRIPTION,
  ...
  INTERSECTION_CONFIG_ERROR_UNIT_FAILURE_FLASH_PERIOD,
