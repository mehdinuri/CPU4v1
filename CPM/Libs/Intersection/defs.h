...
#define THREAD_FLAGS_PROGRAM_SEC_ELAPSED FLAG_BIT_2
...
#define EVENT_FLAGS_MAINTENANCE_PROGRAM_TASK_ACTIVE FLAG_BIT_2
...
#define EVENT_FLAGS_MAINTENANCE_ALL_TASKS_ACTIVE ( \
          EVENT_FLAGS_MAINTENANCE_CPMPCOM_TASK_ACTIVE | \
          EVENT_FLAGS_MAINTENANCE_TIME_TASK_ACTIVE \
          | \
          EVENT_FLAGS_MAINTENANCE_PROGRAM_TASK_ACTIVE \
          | \
...
extern osThreadId_t MMITaskHandle;
...
extern osMemoryPoolId_t MMIReqsMemPoolHandle;
...
extern osMessageQueueId_t MMIReqsQueHandle;
