...
- **Naming**: Follow NTCIP 1202 terminology for NEMA TS2 phase objects (e.g., `phaseMinimumGreen`, `phasePassage`, `phaseYellowChange`, `phaseRedClear`, `unitControl`, `channelControlSource`).
