...
void SystemCoreClockUpdate(void)
{
  ...
  #else  /* if defined (RCC_D1CFGR_D1CPRE) */
  ...
  SystemD2Clock = (common_system_clock >>
                   ((D1CorePrescTable[(RCC->CDCFGR1 & RCC_CDCFGR1_HPRE) >>
                                      RCC_CDCFGR1_HPRE_Pos]) & 0x1FU));

  #endif /* if defined (RCC_D1CFGR_D1CPRE) */
...
void ExitRun0Mode(void)
{
  ...
  #else  /* if defined(USE_PWR_LDO_SUPPLY) */
