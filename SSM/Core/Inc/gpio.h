...
#define GPIOSetR1(fState) HAL_GPIO_WritePin(R1_GPIO_Port, R1_Pin, fState)
#define GPIOSetY1(fState) HAL_GPIO_WritePin(Y1_GPIO_Port, Y1_Pin, fState)
#define GPIOSetG1(fState) HAL_GPIO_WritePin(G1_GPIO_Port, G1_Pin, fState)
#define GPIOSetR2(fState) HAL_GPIO_WritePin(R2_GPIO_Port, R2_Pin, fState)
#define GPIOSetY2(fState) HAL_GPIO_WritePin(Y2_GPIO_Port, Y2_Pin, fState)
#define GPIOSetG2(fState) HAL_GPIO_WritePin(G2_GPIO_Port, G2_Pin, fState)
#define GPIOSetR3(fState) HAL_GPIO_WritePin(R3_GPIO_Port, R3_Pin, fState)
#define GPIOSetY3(fState) HAL_GPIO_WritePin(Y3_GPIO_Port, Y3_Pin, fState)
#define GPIOSetG3(fState) HAL_GPIO_WritePin(G3_GPIO_Port, G3_Pin, fState)
#define GPIOSetR4(fState) HAL_GPIO_WritePin(R4_GPIO_Port, R4_Pin, fState)
#define GPIOSetY4(fState) HAL_GPIO_WritePin(Y4_GPIO_Port, Y4_Pin, fState)
#define GPIOSetG4(fState) HAL_GPIO_WritePin(G4_GPIO_Port, G4_Pin, fState)
